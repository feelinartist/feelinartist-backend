...
exports.redesSocialesData = void 0;
exports.seedRedesSociales = seedRedesSociales;
exports.redesSocialesData = [
...
async function seedRedesSociales(prisma) {
    console.log('🌱 Seeding Redes Sociales...');
    for (const red of exports.redesSocialesData) {
